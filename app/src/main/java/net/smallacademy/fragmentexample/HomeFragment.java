...
//    private OnFragmentItemSelectedListener listener;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recview.setLayoutManager(gridLayout);
        FirebaseRecyclerOptions<RestaurentModel> options =
                new FirebaseRecyclerOptions.Builder<RestaurentModel>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("restaurants"), RestaurentModel.class)
                        .build();
        adapter=new RestaurentAdapter(options);

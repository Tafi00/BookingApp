...
public class FavFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        FirebaseRecyclerOptions<fav_model> options =
                new FirebaseRecyclerOptions.Builder<fav_model>()
                        .setQuery(FirebaseDatabase.getInstance().getReference().child("User").child(FirebaseAuth.getInstance().getCurrentUser().getUid()).child("likes"), fav_model.class)
                        .build();
